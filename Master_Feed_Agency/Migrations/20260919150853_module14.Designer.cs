...
namespace Master_Feed_Agency.Migrations
{
    ...
    [Migration("20260919150853_module14")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Master_Feed_Agency.Models.AuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("IsSecurityEvent", "Timestamp");
            ...
            modelBuilder.Entity("Master_Feed_Agency.Models.CashTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Master_Feed_Agency.Models.DailyClosing", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Master_Feed_Agency.Models.Expense", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("ReversalExpenseId")
                        .HasColumnType("bigint");

                    b.Property<long?>("ReversalOfExpenseId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Master_Feed_Agency.Models.ExpenseCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 9, 19, 0, 0, 0, 0, DateTimeKind.Utc),
            ...
            modelBuilder.Entity("Master_Feed_Agency.Models.NotificationMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("SaleId", "Type", "IsAutomatic");

                    b.ToTable("Notifications", (string)null);
                });

            modelBuilder.Entity("Master_Feed_Agency.Models.Owner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Master_Feed_Agency.Models.OwnerTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Master_Feed_Agency.Models.Expense", b =>
                {
                    b.HasOne("Master_Feed_Agency.Models.ExpenseCategory", "Category")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("Master_Feed_Agency.Models.OwnerTransaction", b =>
                {
                    b.HasOne("Master_Feed_Agency.Models.Owner", "Owner")
